...
void UShooterAnimInstance::TurnInPlace()
{
    ...
    else
    {
       ...
       if (Turning > 0)
       {
            ...
            // If root yaw offset is positive it means we are turning left if it less then 0 it means we are tunirng right
            if  (RootYawOffset > 0)
            {
...
void UShooterAnimInstance::Lean(float DeltaTime)
{
    ...
    FRotator const Delta { UKismetMathLibrary::NormalizedDeltaRotator(CharacterRotation, CharacterRotationLastFrame)};
