...
void AWeapon::OnConstruction(const FTransform& Transform)
{
    ...
    FString const WeaponTablePath {TEXT("DataTable'/Game/_Game/DataTables/WeaponDataTable.WeaponDataTable'")};
    ...
    if (WeapontableObject)
    {
        ...
        if (WeaponDataRow)
        {
            ...
            GetItemMesh()->SetMaterial(PreviusMaterialIndex, nullptr);
...
{
    bMovingSlide = true;
    GetWorldTimerManager().SetTimer(SlideTimer, this, &AWeapon::FinishMovingSlide, MaxSlideDisplacement);
}
